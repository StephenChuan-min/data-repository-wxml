...
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/slicedToArray.js");
...
function genAttrMapFnFromDir(dir) {
  var fn = function fn(key, value) {
    ...
    if (key in dir) {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "j"])(res)) {
        key = res;
      } else {
        key = res[0];
...
function getMappedType(nodeName, rawProps) {
  if (inlineElements.has(nodeName)) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "j"])(mapping)) {
      return mapping;
    }

    var mapName = mapping.mapName;
    return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isFunction */ "h"])(mapName) ? mapName(rawProps) : mapName;
  } else {
    return 'view';
  }
}
...
function getMapNameByCondition(nodeName, attr, props) {
  var mapping = specialElements.get(nodeName);
  if (!mapping || Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "j"])(mapping)) return;
  var mapName = mapping.mapName,
      mapNameCondition = mapping.mapNameCondition;
  if (!mapNameCondition) return;

  if (mapNameCondition.indexOf(attr) > -1 && !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* isString */ "j"])(mapName)) {
...
var hostConfig = {
  modifyHydrateData: function modifyHydrateData(data) {
    var nodeName = data["nn"
    /* NodeName */
    ];
    if (!isHtmlTags(nodeName)) return;
     true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* warn */ "s"])(data["nn"
    /* NodeName */
    ...
    if (attrMapFn) {
      for (var key in data) {
        ...
        var _attrMapFn = attrMapFn(key, value, data),
            _attrMapFn2 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn, 2),
    ...
    if (nodeName === 'br') {
      ...
      data["cn"
      /* Childnodes */
      ] = [(_ref = {}, Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_ref, "nn"
      /* NodeName */
      , '#text'), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(_ref, "v", '\n'), _ref)];
    }
  ...
  modifySetAttrPayload: function modifySetAttrPayload(element, key, payload) {
    ...
    if (attrMapFn) {
      ...
      var _attrMapFn3 = attrMapFn(key, value, props),
          _attrMapFn4 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn3, 2),
    ...
    || key === 'width' || key === 'height') {
      payload.path = "".concat(_path, ".", "st"
      /* Style */
      );
      payload.value = ensureRect(props, element.style.cssText);
    }
  },
  modifyRmAttrPayload: function modifyRmAttrPayload(element, key, payload) {
    var nodeName = element.nodeName,
        _path = element._path,
        props = element.props;
    if (!isHtmlTags(nodeName)) return; // map nodeName
    ...
    if (attrMapFn) {
      ...
      var _attrMapFn5 = attrMapFn(key, value, props),
          _attrMapFn6 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(_attrMapFn5, 1),
...
Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_2__[/* mergeReconciler */ "m"])(hostConfig);
...
var components = {
  ...
  Slider: {
    color: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('#e9e9e9'),
    'selected-color': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('#1aad19')
  },
  Textarea: {
    ...
    'confirm-type': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('return'),
    'confirm-hold': 'false',
    bindKeyboardHeightChange: ''
  },
  ScrollView: {
    ...
    'refresher-default-style': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('black'),
    'refresher-background': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('#FFF'),
  ...
  Swiper: {
    'snap-to-edge': 'false',
    'easing-function': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('default')
  },
  SwiperItem: {
    'skip-hidden-item-layout': 'false'
  },
  Navigator: {
    target: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('self'),
    'app-id': '',
    path: '',
    'extra-data': '',
    version: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('version')
  },
  Camera: {
    mode: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('normal'),
    resolution: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('medium'),
    'frame-size': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('medium'),
    bindInitDone: '',
    bindScanCode: ''
  },
  Image: {
  ...
  LivePlayer: {
    mode: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('live'),
    'sound-mode': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('speaker'),
  ...
  Video: {
    title: '',
    'play-btn-position': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('bottom'),
  ...
  Ad: {
    'ad-type': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('banner'),
    'ad-theme': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('white')
  },
  CoverView: {
    'marker-id': '',
    slot: ''
  ...
  FunctionalPageNavigator: {
    version: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('release'),
    name: '',
    args: '',
    bindSuccess: '',
    bindFail: '',
  ...
  LivePusher: {
    url: '',
    mode: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('RTC'),
    autopush: 'false',
    muted: 'false',
    'enable-camera': 'true',
    'auto-focus': 'true',
    orientation: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('vertical'),
    beauty: '0',
    whiteness: '0',
    aspect: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('9:16'),
    'min-bitrate': '200',
    'max-bitrate': '1000',
    'audio-quality': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('high'),
    'waiting-image': '',
    'waiting-image-hash': '',
    zoom: 'false',
    'device-position': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('front'),
    ...
    'enable-agc': 'false',
    'enable-ans': 'false',
    'audio-volume-type': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('voicecall'),
    'video-width': '360',
    'video-height': '640',
    'beauty-style': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('smooth'),
    filter: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('standard'),
    animation: '',
    bindStateChange: '',
    bindNetStatus: '',
    bindBgmStart: '',
  ...
  OpenData: {
    type: '',
    'open-gid': '',
    lang: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('en'),
    'default-text': '',
    'default-avatar': '',
    bindError: ''
  },
  NavigationBar: {
    ...
    'color-animation-timing-func': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('linear')
  },
  PageMeta: {
    ...
    'scroll-top': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])(''),
    'scroll-duration': '300',
    'page-style': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])(''),
    'root-font-size': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])(''),
    bindResize: '',
    bindScroll: '',
    bindScrollDone: ''
  },
  VoipRoom: {
    openid: '',
    mode: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('camera'),
    'device-position': Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('front'),
    bindError: ''
  },
  AdCustom: {
  ...
  PageContainer: {
    ...
    'z-index': '100',
    overlay: 'true',
    position: Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_0__[/* singleQuote */ "p"])('bottom'),
    round: 'false',
...
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/regenerator/index.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/asyncToGenerator.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/slicedToArray */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_set__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/set */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/set.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/toConsumableArray.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/get */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/get.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/getPrototypeOf */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/getPrototypeOf.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_wrapNativeSuper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/wrapNativeSuper */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/wrapNativeSuper.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toArray__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toArray */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/toArray.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/assertThisInitialized */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/assertThisInitialized.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/inherits */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/inherits.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createSuper */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/createSuper.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/defineProperty */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/classCallCheck */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/classCallCheck.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/createClass */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/createClass.js");
/* harmony import */ var E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/typeof */ "./node_modules/_@babel_runtime@7.15.4@@babel/runtime/helpers/esm/typeof.js");
...
if (false) {} else {
  ...
  (function (Reflect) {
    ...
    (function (factory) {
      ...
      var usePolyfill = (typeof process === "undefined" ? "undefined" : Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(process)) === "object" && process.env && process.env["REFLECT_METADATA_USE_MAP_POLYFILL"] === "true";
      ...
      function Type(x) {
        ...
        switch (Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(x)) {
          case "undefined":
            return 0
            /* Undefined */
            ;
      ...
      function IsSymbol(x) {
        return Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(x) === "symbol";
      } // 6.1.7 The Object Type
      // https://tc39.github.io/ecma262/#sec-object-type


      function IsObject(x) {
        return Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(x) === "object" ? x !== null : typeof x === "function";
      } // 7.1 Type Conversion
...
function __decorate(decorators, target, key, desc) {
  var c = arguments.length,
      ...
      d;
  if ((typeof Reflect === "undefined" ? "undefined" : Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(Reflect)) === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);else for (var i = decorators.length - 1; i >= 0; i--) {
...
function __metadata(metadataKey, metadataValue) {
  if ((typeof Reflect === "undefined" ? "undefined" : Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(Reflect)) === "object" && typeof Reflect.metadata === "function") return Reflect.metadata(metadataKey, metadataValue);
}
...
var TaroEventTarget = /*#__PURE__*/function () {
  ...
  hooks) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroEventTarget);

    this.__handlers = {};
    this.hooks = hooks;
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroEventTarget, [{
    ...
    value: function addEventListener(type, handler, options) {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isObject */ "i"])(options)) {
      ...
      if (isOnce) {
       ...
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(isCapture, 'Taro 暂未实现 event 的 capture 特性。');

      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(handlers)) {
    ...
    value: function removeEventListener(type, handler) {
      ...
      var index = handlers.indexOf(handler);
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(index === -1, "\u4E8B\u4EF6: '".concat(type, "' \u6CA1\u6709\u6CE8\u518C\u5728 DOM \u4E2D\uFF0C\u56E0\u6B64\u4E0D\u4F1A\u88AB\u79FB\u9664\u3002"));
...
function hydrate(node) {
  ...
  if (isText(node)) {
    ...
    return _ref = {}, Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_ref, "v"
    /* Text */
    , node.nodeValue), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_ref, "nn"
    /* NodeName */
    , nodeName), _ref;
  }

  var data = (_data = {}, Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_data, "nn"
  /* NodeName */
  , nodeName), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])(_data, "uid", node.uid), _data);
  ...
  for (var prop in props) {
    var propInCamelCase = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toCamelCase */ "q"])(prop);
...
var TaroNode = /*#__PURE__*/function (_TaroEventTarget) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(TaroNode, _TaroEventTarget);

  var _super = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroNode);

  function TaroNode( // eslint-disable-next-line @typescript-eslint/indent
  impl, getElement, hooks) {
    var _this;

    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroNode);
    ...
    impl.bind(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this));
    _this._getElement = getElement;
    _this.uid = "_n_".concat(nodeId());
    eventSource.set(_this.uid, Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this));
    return _this;
  }
  /**
   * like jQuery's $.empty()
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroNode, [{
    key: "_empty",
    ...
    value: function findIndex(refChild) {
      ...
      Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(index !== -1, 'The node to be replaced is not a child of this node.');
      return index;
    }
  }, {
    key: "_path",
...
var TaroText = /*#__PURE__*/function (_TaroNode) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(TaroText, _TaroNode);

  var _super2 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroText);

  function TaroText( // eslint-disable-next-line @typescript-eslint/indent
  nodeImpl, getElement, hooks) {
    var _this4;

    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroText);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroText, [{
    key: "textContent",
    get: function get() {
      return this._value;
    },
...
function setStyle(newVal, styleKey) {
  ...
  if (newVal) {
   ...
   true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isString */ "j"])(newVal) && newVal.length > PROPERTY_THRESHOLD, "Style \u5C5E\u6027 ".concat(styleKey, " \u7684\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\uFF0C\u8003\u8651\u4F7F\u7528 CSS \u7C7B\u6216\u5176\u5B83\u65B9\u6848\u66FF\u4EE3\u3002"));
...
var Style = /*#__PURE__*/function () {
  function Style(element) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Style);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Style, [{
    key: "setCssVariables",
    ...
    get: function get() {
      ...
      this._usedStyleProp.forEach(function (key) {
        var val = _this6[key];
        if (!val) return;
        var styleName = isCssVariable(key) ? key : Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toDashed */ "r"])(key);
    ...
    set: function set(str) {
      ...
      for (var i = 0; i < rules.length; i++) {
        ...
        var _rule$split = rule.split(':'),
            _rule$split2 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toArray__WEBPACK_IMPORTED_MODULE_8__[/* default */ "a"])(_rule$split),
            propName = _rule$split2[0],
            valList = _rule$split2.slice(1);

        var val = valList.join(':');

        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isUndefined */ "k"])(val)) {
          continue;
        }
    ...
    value: function setProperty(propertyName, value) {
      if (propertyName[0] === '-') {
        ...
        propertyName = Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toCamelCase */ "q"])(propertyName);
      }

      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isUndefined */ "k"])(value)) {
        return;
      }
...
var ClassList = /*#__PURE__*/function (_Set2) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(ClassList, _Set2);

  var _super3 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(ClassList);

  function ClassList(className, el) {
    var _thisSuper, _this8;

    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, ClassList);

    _this8 = _super3.call(this);
    className.trim().split(/\s+/).forEach(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])((_thisSuper = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this8), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype)), "add", _thisSuper).bind(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this8)));
    _this8.el = el;
    return _this8;
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(ClassList, [{
    key: "value",
    get: function get() {
      return Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(this).join(' ');
    }
  }, {
    key: "add",
    value: function add(s) {
      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype), "add", this).call(this, s);
    ...
    value: function toggle(s) {
      if (Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype), "has", this).call(this, s)) {
        Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype), "delete", this).call(this, s);
      } else {
        Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype), "add", this).call(this, s);
      }
    ...
    value: function contains(s) {
      return Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_get__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(ClassList.prototype), "has", this).call(this, s);
    }
  }, {
    key: "toString",
  ...
  return ClassList;
}( /*#__PURE__*/Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_wrapNativeSuper__WEBPACK_IMPORTED_MODULE_7__[/* default */ "a"])(Set));

var TaroElement = /*#__PURE__*/function (_TaroNode2) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(TaroElement, _TaroNode2);

  var _super4 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroElement);

  function TaroElement( // eslint-disable-next-line @typescript-eslint/indent
  nodeImpl, getElement, hooks, elementImpl) {
    var _this9;

    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroElement);
    ...
    elementImpl.bind(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this9));
    _this9.nodeType = 1
    /* ELEMENT_NODE */
    ;
    _this9.style = new Style(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this9));
    hooks.patchElement(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"])(_this9));
    return _this9;
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroElement, [{
    ...
    value: function _stopPropagation(event) {
      ...
      while (target = target.parentNode) {
        ...
        if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(listeners)) {
          continue;
        }
    ...
    set: function set(text) {
      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_set__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(TaroElement.prototype), "textContent", text, this, true);
    }
  }, {
    key: "hasAttribute",
    value: function hasAttribute(qualifiedName) {
      return !Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isUndefined */ "k"])(this.props[qualifiedName]);
    }
  }, {
    key: "hasAttributes",
    ...
    value: function setAttribute(qualifiedName, value) {
      var _a, _b;
       ...
       true && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* warn */ "s"])(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isString */ "j"])(value) && value.length > PROPERTY_THRESHOLD, "\u5143\u7D20 ".concat(this.nodeName, " \u7684 \u5C5E\u6027 ").concat(qualifiedName, " \u7684\u503C\u6570\u636E\u91CF\u8FC7\u5927\uFF0C\u53EF\u80FD\u4F1A\u5F71\u54CD\u6E32\u67D3\u6027\u80FD\u3002\u8003\u8651\u964D\u4F4E\u56FE\u7247\u8F6C\u4E3A base64 \u7684\u9608\u503C\u6216\u5728 CSS \u4E2D\u4F7F\u7528 base64\u3002"));
      ...
      switch (qualifiedName) {
        ...
        default:
          ...
          if (qualifiedName.startsWith('data-')) {
            if (this.dataset === _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"]) {
              this.dataset = Object.create(null);
            }

            this.dataset[Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toCamelCase */ "q"])(qualifiedName.replace(/^data-/, ''))] = value;
          }
      ...
      var payload = {
        path: "".concat(this._path, ".").concat(Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toCamelCase */ "q"])(qualifiedName)),
        value: value
      };
      ...
      if (this.nodeName === VIEW) {
        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* toCamelCase */ "q"])(qualifiedName) === CATCHMOVE) {
...
var freeGlobal = (typeof global === "undefined" ? "undefined" : Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(global)) == 'object' && global && global.Object === Object && global;
/** Detect free variable `self`. */

var freeSelf = (typeof self === "undefined" ? "undefined" : Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(self)) == 'object' && self && self.Object === Object && self;
...
function isObjectLike(value) {
  return value != null && Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(value) == 'object';
}
/** `Object#toString` result references. */
...
function isSymbol(value) {
  return Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(value) == 'symbol' || isObjectLike(value) && baseGetTag(value) == symbolTag;
}
...
function isKey(value, object) {
  ...
  var type = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(value);
...
var Performance = /*#__PURE__*/function () {
  function Performance() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Performance);

    this.recorder = new Map();
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Performance, [{
    key: "start",
...
var TaroRootElement = /*#__PURE__*/function (_TaroElement) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(TaroRootElement, _TaroElement);

  var _super5 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroRootElement);
  ...
  nodeImpl, getElement, hooks, elementImpl, eventCenter) {
    ...
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroRootElement);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroRootElement, [{
    key: "_path",
    get: function get() {
      return ROOT_STR;
    }
    ...
    value: function performUpdate() {
      ...
      setTimeout(function () {
        ...
        var _loop2 = function _loop2(_path) {
          ...
          if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(value)) {
            data[_path] = value();
          }
        };
        ...
        if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(prerender)) {
          prerender(data);
        } else {
              ...
              for (var i = dataPathArr.length; i > 0; i--) {
                ...
                if (getData && getData.nn && getData.nn === CUSTOM_WRAPPER) {
                  ...
                  if (customWrapper) {
                    ...
                    customWrapperMap.set(customWrapper, Object.assign(Object.assign({}, customWrapperMap.get(customWrapper) || {}), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])({}, "i.".concat(splitedPath), data[p])));
                  }
...
var FormElement = /*#__PURE__*/function (_TaroElement2) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(FormElement, _TaroElement2);

  var _super6 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(FormElement);

  function FormElement() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, FormElement);

    return _super6.apply(this, arguments);
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(FormElement, [{
    key: "value",
    get: function get() {
...
var SVGElement = /*#__PURE__*/function (_TaroElement3) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(SVGElement, _TaroElement3);

  var _super7 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(SVGElement);

  function SVGElement() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, SVGElement);
...
var Scaner = /*#__PURE__*/function () {
  function Scaner(html) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Scaner);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Scaner, [{
    key: "scan",
    value: function scan() {
      var html = this.html,
...
var internalCompsList = Object.keys(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* internalComponents */ "e"]).map(function (i) {
...
var StyleTagParser = /*#__PURE__*/function () {
  function StyleTagParser() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, StyleTagParser);

    this.styles = [];
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(StyleTagParser, [{
    key: "extractStyle",
      ...
      var selectors = list.map(function (item) {
        ...
        item = item.replace(/\[(.+?)\]/g, function (_, $1) {
          var _$1$split = $1.split('='),
              _$1$split2 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_$1$split, 2),
              key = _$1$split2[0],
              value = _$1$split2[1];
...
function format(children, document, styleOptions, parent) {
  return children.filter(function (child) {
    ...
    if (child.type === 'text') {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(options.html.transformText)) {
    ...
    for (var i = 0; i < child.attributes.length; i++) {
      ...
      var _splitEqual = splitEqual(attr),
          _splitEqual2 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"])(_splitEqual, 2),
          key = _splitEqual2[0],
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(options.html.transformElement)) {
...
function cloneNode(ctx, getDoc) {
  ...
  for (var key in this) {
    ...
    if ([PROPS, DATASET].includes(key) && Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_15__[/* default */ "a"])(value) === OBJECT) {
...
var TaroNodeImpl = /*#__PURE__*/function () {
  ...
  getElement) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroNodeImpl);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroNodeImpl, [{
    key: "bind",
...
var TaroElementImpl = /*#__PURE__*/function () {
  function TaroElementImpl() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroElementImpl);
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroElementImpl, [{
    key: "bind",
    value: function bind(ctx) {
      if (true) {
        ctx.getBoundingClientRect = /*#__PURE__*/Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])( /*#__PURE__*/E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
          var _len,
              args,
              _key,
              _args = arguments;

          return E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
...
var TaroDocument = /*#__PURE__*/function (_TaroElement4) {
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(TaroDocument, _TaroElement4);

  var _super8 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(TaroDocument);

  function TaroDocument( // eslint-disable-next-line @typescript-eslint/indent
  nodeImpl, getElement, hooks, elementImpl, getText) {
    var _this17;

    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroDocument);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroDocument, [{
    key: "createElement",
    value: function createElement(type) {
      ...
      if (_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* controlledComponent */ "b"].has(type)) {
    ...
    value: function getElementById(id) {
      ...
      return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isUndefined */ "k"])(el) ? null : el;
    }
  }, {
    key: "querySelector",
...
var Hooks = /*#__PURE__*/function () {
  function Hooks() {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Hooks);
  }

  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Hooks, [{
    key: "modifyMpEvent",
...
function processPluginHooks(container) {
  var keys = Object.keys(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* defaultReconciler */ "c"]);
  keys.forEach(function (key) {
    if (key in SERVICE_IDENTIFIER) {
      // is hooks
      var identifier = SERVICE_IDENTIFIER[key];
      var fn = _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* defaultReconciler */ "c"][key];

      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(fn)) {
        // is multi
...
var TaroEvent = /*#__PURE__*/function () {
  function TaroEvent(type, opts, event) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, TaroEvent);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(TaroEvent, [{
    key: "stopPropagation",
    ...
    get: function get() {
      ...
      return Object.assign(Object.assign(Object.assign({}, (_b = this.mpEvent) === null || _b === void 0 ? void 0 : _b.target), (_c = this.mpEvent) === null || _c === void 0 ? void 0 : _c.detail), {
        dataset: element !== null ? element.dataset : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"]
      });
    }
  }, {
    key: "currentTarget",
...
var doc = isBrowser ? document : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
var win = isBrowser ? window : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
...
if (!isBrowser) {
  var globalProperties = [].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(Object.getOwnPropertyNames(global || win)), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(Object.getOwnPropertySymbols(global || win)));
...
var Events = /*#__PURE__*/function () {
  function Events(opts) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Events);
  ...
  Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Events, [{
    key: "on",
...
function safeExecute(path, lifecycle) {
  ...
  if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(func)) {
  ...
  if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(func)) {
    return;
  }
...
function createPageConfig(component, pageName, data, pageConfig) {
    ...
    onLoad: function onLoad(options, cb) {
      ...
      var mount = function mount() {
        Current.app.mount(component, _this19.$taroPath, function () {
          ...
          Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(pageElement !== null, '没有找到页面实例。');
          ...
          if (!isBrowser) {
            ...
            Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(cb) && cb();
          }
        });
      };
  ...
  if (!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isUndefined */ "k"])(data)) {
    config.data = data;
  }
...
function createComponentConfig(component, componentName, data) {
  ...
  var config = {
    attached: function attached() {
      ...
      Current.app.mount(component, path, function () {
        ...
        Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(componentElement !== null, '没有找到组件实例。');
  ...
  config['options'] = (_a = component === null || component === void 0 ? void 0 : component['options']) !== null && _a !== void 0 ? _a : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
  config['externalClasses'] = (_b = component === null || component === void 0 ? void 0 : component['externalClasses']) !== null && _b !== void 0 ? _b : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
  config['behaviors'] = (_c = component === null || component === void 0 ? void 0 : component['behaviors']) !== null && _c !== void 0 ? _c : _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
  return config;
}
...
function createRecursiveComponentConfig(componentName) {
  return {
    properties: {
      i: {
        type: Object,
        value: Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"])({}, "nn"
        /* NodeName */
        , 'view')
      },
      l: {
...
function isClassComponent(R, component) {
  ...
  return Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(component.render) || !!((_a = component.prototype) === null || _a === void 0 ? void 0 : _a.isReactComponent) || component.prototype instanceof R.Component; // compat for some others react-like library
} // 初始值设置为 any 主要是为了过 TS 的校验


var R = _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
var PageContext = _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"];
...
function connectReactPage(R, id) {
  ...
  return function (component) {
    ...
    if (PageContext === _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* EMPTY_OBJ */ "a"]) {
      PageContext = R.createContext('');
    }

    return /*#__PURE__*/function (_R$Component) {
      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(Page, _R$Component);

      var _super9 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(Page);

      function Page() {
        var _this22;

        Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Page);
      ...
      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Page, [{
  ...
  var mergePageInstance = function mergePageInstance(prev, next) {
    ...
    Object.keys(prev).forEach(function (item) {
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(next[item])) {
        next[item] = [next[item]].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(prev[item]));
      } else {
        next[item] = [].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(next[item] || []), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(prev[item]));
      }
    });
  };
...
function createReactApp(App, react, reactdom, config) {
  R = react;
  ReactDOM = reactdom;
  Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(!!ReactDOM, '构建 React/Nerv 项目请把 process.env.FRAMEWORK 设置为 \'react\'/\'nerv\' ');
  var ref = R.createRef();
  var isReactComponent = isClassComponent(R, App);
  setReconciler();

  var AppWrapper = /*#__PURE__*/function (_R$Component2) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(AppWrapper, _R$Component2);

    var _super10 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(AppWrapper);

    function AppWrapper() {
      var _this23;

      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, AppWrapper);
    ...
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(AppWrapper, [{
      key: "mount",
  ...
  var app = Object.create({
    ...
    onLaunch: {
      ...
      value: function value(options) {
        ...
        if (app != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(app.onLaunch)) {
    ...
    onShow: {
      ...
      value: function value(options) {
        ...
        if (app != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(app.componentDidShow)) {
    ...
    onHide: {
      ...
      value: function value(options) {
        ...
        if (app != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(app.componentDidHide)) {
    ...
    onPageNotFound: {
      ...
      value: function value(res) {
        ...
        if (app != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(app.onPageNotFound)) {
...
function initNativeComponentEntry(R, ReactDOM) {
  var NativeComponentWrapper = /*#__PURE__*/function (_R$Component3) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(NativeComponentWrapper, _R$Component3);

    var _super11 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(NativeComponentWrapper);

    function NativeComponentWrapper() {
      var _this25;

      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, NativeComponentWrapper);
    ...
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(NativeComponentWrapper, [{
  ...
  var Entry = /*#__PURE__*/function (_R$Component4) {
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"])(Entry, _R$Component4);

    var _super12 = Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createSuper__WEBPACK_IMPORTED_MODULE_11__[/* default */ "a"])(Entry);

    function Entry() {
      var _this26;

      Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"])(this, Entry);
    ...
    Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_14__[/* default */ "a"])(Entry, [{
      key: "componentDidMount",
      value: function componentDidMount() {
        Current.app = this;
      }
      ...
      value: function mount(Component, compId, getCtx) {
        ...
        this.setState({
          components: [].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(this.state.components), [item])
        });
      }
    }, {
      key: "unmount",
      value: function unmount(compId) {
        ...
        var next = [].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(components.slice(0, index)), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(components.slice(index + 1)));
        this.setState({
          components: next
        });
      }
...
function setReconciler$1() {
  ...
  var onRemoveAttribute = function onRemoveAttribute(dom, qualifiedName) {
    ...
    if (!props.hasOwnProperty(qualifiedName) || Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isBoolean */ "g"])(props[qualifiedName])) {
...
function createVueApp(App, vue, config) {
  Vue = vue;
  Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(!!Vue, '构建 Vue 项目请把 process.env.FRAMEWORK 设置为 \'vue\'');
  setReconciler$1();
  Vue.config.getTagNamespace = _tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* noop */ "n"];
  var elements = [];
  var pages = [];
  var appInstance;
  var wrapper = new Vue({
  ...
  var app = Object.create({
    ...
    onLaunch: {
      ...
      value: function value(options) {
        ...
        if (appInstance != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(appInstance.$options.onLaunch)) {
    ...
    onShow: {
      ...
      value: function value(options) {
        ...
        if (appInstance != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(appInstance.$options.onShow)) {
    ...
    onHide: {
      ...
      enumerable: true,
      value: function value(options) {
        if (appInstance != null && Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(appInstance.$options.onHide)) {
...
function createVue3Page(h, id) {
  return function (component) {
    ...
    if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(component.mixins)) {
...
function createVue3App(app, h, config) {
  var pages = [];
  var appInstance;
  Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* ensure */ "d"])(!Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(app._component), '入口组件不支持使用函数式组件');
  setReconciler$2();
  ...
  var appConfig = Object.create({
    ...
    onLaunch: {
      ...
      value: function value(options) {
        ...
        Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(onLaunch) && onLaunch.call(appInstance, options);
      }
    },
    onShow: {
      writable: true,
      ...
      value: function value(options) {
        ...
        Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(onShow) && onShow.call(appInstance, options);
      }
    },
    onHide: {
      writable: true,
      ...
      value: function value(options) {
        ...
        Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(onHide) && onHide.call(appInstance, options);
      }
    }
  });
  ...
  return function (fn) {
    ...
    R.useLayoutEffect(function () {
      ...
      if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isFunction */ "h"])(inst[lifecycle])) {
        ...
        inst[lifecycle] = [].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(inst[lifecycle] || []), [callback]);
      }
      ...
      return function () {
        ...
        } else if (Object(_tarojs_shared__WEBPACK_IMPORTED_MODULE_17__[/* isArray */ "f"])(list)) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return singleQuote; });
...
function isObject(o) {
  return o !== null && Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_typeof__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(o) === 'object';
}
...
function processApis(taro, global) {
  ...
  var _needPromiseApis = new Set([].concat(Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(patchNeedPromiseApis), Object(E_wangchuan_work_projects_data_repository_wxml_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(needPromiseApis)));
